...
int main() {
    ...
    // Use flags = 1 as in the multithreaded reader sample
    int flags = 1;
    ...
    if (acquire_ret.first == chronolog::CL_SUCCESS) {
        ...
        // In the multithreaded example the segment boundaries are provided by the writer.
        // Here we assume we want to read the entire story.
        ...
        // Release the story (as in the multithreaded code)
